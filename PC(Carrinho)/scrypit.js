...
produtos.forEach(prod => {
  ...
  card.innerHTML = `
    <button class="icon-btn share" title="Compartilhar produto">
      <i class="fa-solid fa-share-nodes"></i>
    </button>
    <button class="icon-btn favorite" title="Adicionar aos favoritos">
...
container.addEventListener('click', e => {
  ...
  if (btn.classList.contains('plus')) {
    ...
    const shareText = `Olha esse produto na Inova Look: ${name}`;
    if (navigator.share) {
